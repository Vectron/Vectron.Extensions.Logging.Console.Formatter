...
internal sealed class ThemeProvider : IThemeProvider, IDisposable
{
    ...
    private SingleLineConsoleFormatterOptions formatterOptions;
    ...
    public ThemeProvider(IOptionsMonitor<SingleLineConsoleFormatterOptions> options, IEnumerable<ITheme> themes)
    {
        this.themes = themes;
